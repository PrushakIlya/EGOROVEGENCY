...
<!-- <section class="game-section">
  <div class="game wrapper">
    ...
    <form action="/test" method="POST" class="game_block" name="game_block">
      <input type="button" class="cell" id="0" onclick="move(0)">
      <input type="button" class="cell" id="1" onclick="move(1)">
      <input type="button" class="cell" id="2" onclick="move(2)">
      <input type="button" class="cell" id="3" onclick="move(3)">
      <input type="button" class="cell" id="4" onclick="move(4)">
      <input type="button" class="cell" id="5" onclick="move(5)">
      <input type="button" class="cell" id="6" onclick="move(6)">
      <input type="button" class="cell" id="7" onclick="move(7)">
      <input type="button" class="cell" id="8" onclick="move(8)">
    </form>
